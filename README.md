...
- 🎨 **最新图像生成** - Gemini 2.5 Flash Image Preview，支持对话式生成和编辑
- 🔊 **高质量音频** - 多提供商TTS支持，MiniMax中文优质语音
- 🎬 **视频处理** - 智能字幕、动画效果、完整合成流水线
- 🚀 **批量处理** - 异步并发，支持大规模生产
...
├── media/                   # 媒体生成模块
│   ├── image_generator.py   # 图像生成（Gemini 2.5/RunningHub/OpenAI/Stability）
...
**图像生成:**
- Gemini 2.5 Flash Image Preview (主要) - Google最新文生图模型
- RunningHub (备用1) - 对应原工作流配置
- OpenAI DALL-E (备用2)
- Stability AI (备用3)

**音频合成:**
- MiniMax TTS (主要) - 高质量中文语音合成
- Azure TTS (备用1) - 悬疑解说音色
- ElevenLabs (备用2) - 高质量英语语音
- OpenAI TTS (备用3)
