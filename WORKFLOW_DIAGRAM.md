...
graph TD
    ...
    C --> E{🏪 提供商选择}
    E -->|主力| F[🚀 Gemini 2.5 Flash Image Preview]
    E -->|备用1| G[🏠 RunningHub]
    E -->|备用2| H[🎨 OpenAI DALL-E]
    E -->|备用3| I[🌟 Stability AI]
...
### 🚀 Gemini 2.5 Flash Image Preview 图像生成流程

```mermaid
graph TB
    A[🎨 图像提示词] --> B{💰 质量选择}
    B -->|标准质量| C[🆓 免费版本<br/>gemini-2.5-flash-image-preview:free]
    B -->|高质量| D[💎 付费版本<br/>gemini-2.5-flash-image-preview]
    
    C --> E[📝 构建Chat Messages]
    D --> E
    
    E --> F[🌐 OpenRouter API调用]
    F --> G{📊 响应处理}
    
    G -->|Base64数据| H[🔄 Base64解码]
    G -->|图像URL| I[📥 下载图像]
